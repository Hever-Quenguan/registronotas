...
import { KeycloakService } from '../../core/services/keycloak.service'; // ✅ Nuevo servicio
...
export class TopbarComponent implements OnInit {
  ...
  constructor(
    ...
    private keycloakService: KeycloakService, // ✅ Inyectamos KeycloakService
  ...
  logout() {
    ...
    this.keycloakService.logout(); // ✅ Solo usamos Keycloak
    // Opcional: Redirigir al login al salir
    // this.keycloakService.instance.logout({ redirectUri: window.location.origin });
  }
